...
const ATT=[
  {id:"hagia",title:"Hagia Sophia",cat:"Landmark",price:25,dur:"1.5h",rating:4.9,img:"/hagia.jpg",badge:"Most booked",skip:true,link:"https://gyg.me/9TxDoMwH",area:"Sultanahmet",teaser:"Byzantine meets Ottoman in one breathtaking space"},
  {id:"basilica",title:"Basilica Cistern",cat:"Museum",price:20,dur:"1h",rating:4.8,img:"/basilica.jpg",badge:"Fast entry",skip:true,link:"https://gyg.me/HyHBAHab",area:"Sultanahmet",teaser:"336 marble columns underground with Medusa heads"},
  {id:"topkapi",title:"Topkapi Palace",cat:"Palace",price:30,dur:"2.5h",rating:4.9,img:"/topkapi.jpg",badge:"High value",skip:true,link:"https://gyg.me/zHWCA6tY",area:"Sultanahmet",teaser:"400 years of Ottoman sultans, treasury, and Bosphorus views"},
  {id:"cruise",title:"Bosphorus Cruise",cat:"Experience",price:18,dur:"2h",rating:4.7,img:"/cruise.jpg",badge:"Sunset pick",skip:false,link:"https://gyg.me/Ou6l1R0E",area:"Eminönü",teaser:"See two continents from the water at sunset"},
  {id:"hammam",title:"Turkish Bath",cat:"Wellness",price:45,dur:"1.5h",rating:4.8,img:"/hammam.jpg",badge:"Authentic",skip:false,link:"https://gyg.me/wdfMolAo",area:"Various",teaser:"Steam, marble, and a proper scrub — pure renewal"},
  {id:"galata",title:"Galata Tower",cat:"Viewpoint",price:15,dur:"45min",rating:4.6,img:"/galata.jpg",badge:"360° view",skip:true,link:"https://gyg.me/NCnQgklA",area:"Beyoğlu",teaser:"Best panoramic view from a medieval stone tower"},
  {id:"dolma",title:"Dolmabahçe Palace",cat:"Palace",price:28,dur:"2h",rating:4.7,img:"/dolma.jpg",badge:"Crystal stairs",skip:true,link:"https://gyg.me/FhcexQTY",area:"Beşiktaş",teaser:"Crystal staircase, 4.5-ton chandelier, Bosphorus-front"},
  {id:"dervish",title:"Whirling Dervish",cat:"Culture",price:22,dur:"1h",rating:4.9,img:"/dervish.jpg",badge:"Unique",skip:false,link:"https://gyg.me/MZyCEeij",area:"Various",teaser:"800-year-old Sufi ceremony — deeply moving"},
  {id:"islands",title:"Princes' Islands",cat:"Day Trip",price:35,dur:"Full day",rating:4.7,img:"/islands.jpg",badge:"Day trip",skip:false,link:"https://gyg.me/50M4D75g",area:"Sea of Marmara",teaser:"Car-free islands, pine forests, best seafood lunch"},
  {id:"cooking",title:"Turkish Cooking Class",cat:"Experience",price:50,dur:"4h",rating:4.9,img:"/cooking.jpg",badge:"Top rated",skip:false,link:"https://gyg.me/TyiQJFVC",area:"Various",teaser:"Market visit + cook manti to baklava with a local chef"},
  {id:"foodtour",title:"Istanbul Food Tour",cat:"Experience",price:40,dur:"3.5h",rating:4.8,img:"/foodtour.jpg",badge:"Bestseller",skip:false,link:"https://gyg.me/0KLewel5",area:"Various",teaser:"Street simit to hidden meyhane gems with a local guide"},
  {id:"hoponoff",title:"Hop-on Hop-off Bus",cat:"Transport",price:28,dur:"Full day",rating:4.4,img:"/hoponoff.jpg",badge:"Flexible",skip:false,link:"https://gyg.me/0hgJBsgt",area:"City-wide",teaser:"Open-top city overview with audio guide in 10+ languages"},
  {id:"nightcruise",title:"Dinner Cruise",cat:"Experience",price:55,dur:"3h",rating:4.6,img:"/nightcruise.jpg",badge:"Romantic",skip:false,link:"https://gyg.me/8f0VjFBO",area:"Eminönü",teaser:"Candlelit dinner with live music on the illuminated Bosphorus"},
  {id:"aquarium",title:"Istanbul Aquarium",cat:"Family",price:22,dur:"2h",rating:4.5,img:"/aquarium.jpg",badge:"Family pick",skip:true,link:"https://gyg.me/8drJtohU",area:"Florya",teaser:"16 themed zones, shark tunnel, touch pools"},
  {id:"maiden",title:"Maiden's Tower",cat:"Landmark",price:20,dur:"1.5h",rating:4.7,img:"/maiden.jpg",badge:"Iconic",skip:false,link:"https://gyg.me/3vDd9xwf",area:"Üsküdar",teaser:"Restored island tower with café and old city views"},
];

const GUIDES=[
  {id:"must-see",title:"Must-See Places",sub:"The iconic landmarks every visitor should see",emoji:"🏛️",ids:["hagia","basilica","topkapi","galata","dolma","maiden"],pick:"hagia"},
  {id:"hidden-gems",title:"Hidden Gems",sub:"Beyond the obvious — local favorites",emoji:"💎",ids:["dervish","cooking","foodtour","hammam","nightcruise","maiden"],pick:"dervish"},
  {id:"experiences",title:"Best Experiences",sub:"Do something unforgettable",emoji:"✨",ids:["cruise","nightcruise","cooking","foodtour","dervish","islands","hammam"],pick:"cooking"},
  {id:"family",title:"Family Picks",sub:"Fun for all ages",emoji:"👨‍👩‍👧‍👦",ids:["aquarium","islands","hoponoff","cruise","galata"],pick:"aquarium"},
  {id:"rainy",title:"Rainy Day Ideas",sub:"Indoor adventures when it pours",emoji:"🌧️",ids:["basilica","aquarium","hammam","cooking","dervish"],pick:"hammam"},
  {id:"food",title:"Food & Markets",sub:"Eat like a local",emoji:"🍽️",ids:["cooking","foodtour"],pick:"foodtour"},
  {id:"neighborhoods",title:"Neighborhood Guides",sub:"Explore district by district",emoji:"🏘️",ids:[],pick:null},
];

const NEIGHBORHOODS=[
  {n:"Sultanahmet",d:"Historic peninsula — Hagia Sophia, Blue Mosque, Grand Bazaar",img:"/hagia.jpg"},
  {n:"Beyoğlu & Taksim",d:"İstiklal Avenue, nightlife, Galata Tower",img:"/galata.jpg"},
  {n:"Kadıköy",d:"Asian side, local food scene, vibrant markets",img:"/foodtour.jpg"},
  {n:"Balat & Fener",d:"Colorful streets, Instagram-famous houses, cafés",img:"/basilica.jpg"},
  {n:"Ortaköy",d:"Bosphorus views, kumpir street food, iconic mosque",img:"/cruise.jpg"},
  {n:"Karaköy",d:"Waterfront cafés, street art, boutique hotels",img:"/maiden.jpg"},
];

const PLAN_DAYS=[{day:1,title:"Old City Essentials",items:[{t:"09:00",n:"Hagia Sophia",m:"1.5h · skip line",tp:"landmark",id:"hagia"},{t:"10:50",n:"Basilica Cistern",m:"45min · 4 min walk",tp:"museum",id:"basilica"},{t:"12:10",n:"Lunch break",m:"1h · local restaurant",tp:"food"},{t:"13:45",n:"Blue Mosque",m:"40min · free entry",tp:"landmark"},{t:"15:00",n:"Topkapi Palace",m:"2.5h · include Harem",tp:"museum",id:"topkapi"},{t:"18:15",n:"Grand Bazaar",m:"1.5h · closes 19:00",tp:"shopping"}]},{day:2,title:"Bosphorus & Beyoğlu",items:[{t:"09:30",n:"Dolmabahçe Palace",m:"2h · timed entry",tp:"museum",id:"dolma"},{t:"12:15",n:"Bosphorus Cruise",m:"2h · pier boarding",tp:"landmark",id:"cruise"},{t:"15:00",n:"Ortaköy break",m:"45min · street food",tp:"food"},{t:"17:00",n:"Galata Tower",m:"45min · sunset views",tp:"landmark",id:"galata"},{t:"19:00",n:"İstiklal & dinner",m:"shopping + rooftop",tp:"shopping"}]},{day:3,title:"Local Layers",items:[{t:"10:00",n:"Turkish Bath",m:"90min · authentic",tp:"wellness",id:"hammam"},{t:"12:30",n:"Spice Bazaar",m:"1h · souvenirs",tp:"shopping"},{t:"14:00",n:"Balat & Fener",m:"2.5h · colorful streets",tp:"neighborhood"},{t:"17:45",n:"Whirling Dervish",m:"1h · evening ceremony",tp:"culture",id:"dervish"},{t:"19:15",n:"Farewell dinner",m:"Ottoman cuisine",tp:"food"}]}];
...
function MiniPreview({att,onClose,onFullDetail,onFav,isFav}){
  const[show,setShow]=useState(false);
  useEffect(()=>{if(att)setTimeout(()=>setShow(true),10);return()=>setShow(false)},[att?.id]);
  if(!att)return null;
  const close=()=>{setShow(false);setTimeout(onClose,200)};
  const full=()=>{setShow(false);setTimeout(()=>onFullDetail(att),200)};
  return(<div style={{position:"fixed",inset:0,zIndex:250,fontFamily:fi}}>
    <div onClick={close} style={{position:"absolute",inset:0,background:"rgba(15,23,42,0.4)",backdropFilter:"blur(3px)",transition:"opacity 0.2s",opacity:show?1:0}}/>
    <div style={{position:"absolute",bottom:0,left:0,right:0,maxWidth:440,margin:"0 auto",borderRadius:"28px 28px 0 0",background:"white",transform:show?"translateY(0)":"translateY(100%)",transition:"transform 0.3s cubic-bezier(0.32,0.72,0,1)",overflow:"hidden"}}>
      <div style={{width:48,height:5,borderRadius:3,background:T.line,margin:"10px auto 0"}}/>
      {/* Image */}
      <div style={{position:"relative",height:180,margin:"12px 16px 0",borderRadius:20,overflow:"hidden"}}>
        <img src={att.img} alt={att.title} style={{width:"100%",height:"100%",objectFit:"cover"}}/>
        <div style={{position:"absolute",inset:0,background:"linear-gradient(to top,rgba(15,23,42,0.5),transparent 50%)"}}/>
        <div style={{position:"absolute",left:12,top:12}}><Pill tone="rgba(255,255,255,0.9)" color={T.dark}>{att.badge}</Pill></div>
        <div onClick={(e)=>{e.stopPropagation();onFav&&onFav(att.id)}} style={{position:"absolute",top:12,right:12,width:32,height:32,borderRadius:12,background:isFav?"rgba(225,29,72,0.9)":"rgba(0,0,0,0.3)",display:"flex",alignItems:"center",justifyContent:"center",cursor:"pointer"}}><Heart size={14} color="white" fill={isFav?"white":"none"}/></div>
        <div style={{position:"absolute",bottom:12,left:12}}><div style={{fontSize:20,fontWeight:800,color:"white",fontFamily:fd}}>{att.title}</div><div style={{fontSize:12,color:"rgba(255,255,255,0.8)",marginTop:2}}>{att.cat} · {att.area} · <Star size={10} fill="currentColor" style={{verticalAlign:"middle"}}/> {att.rating}</div></div>
      </div>
      {/* Quick facts */}
      <div style={{padding:"12px 16px 0",display:"flex",gap:8}}>
        <div style={{flex:1,borderRadius:12,background:"#F1F5F9",padding:"8px 10px",textAlign:"center"}}><div style={{fontSize:9,color:T.inkMute,textTransform:"uppercase"}}>Duration</div><div style={{fontSize:13,fontWeight:700,marginTop:2}}>{att.dur}</div></div>
        <div style={{flex:1,borderRadius:12,background:"#F1F5F9",padding:"8px 10px",textAlign:"center"}}><div style={{fontSize:9,color:T.inkMute,textTransform:"uppercase"}}>Price</div><div style={{fontSize:13,fontWeight:700,marginTop:2}}>€{att.price}</div></div>
        {att.skip&&<div style={{flex:1,borderRadius:12,background:T.okSoft,padding:"8px 10px",textAlign:"center"}}><div style={{fontSize:9,color:T.ok,textTransform:"uppercase"}}>Skip line</div><div style={{fontSize:13,fontWeight:700,marginTop:2,color:T.ok}}>Yes</div></div>}
      </div>
      {/* Teaser */}
      <div style={{padding:"10px 16px 0",fontSize:13,color:T.inkSoft,lineHeight:1.6}}>{att.teaser}</div>
      {/* CTAs */}
      <div style={{padding:"14px 16px 24px",display:"flex",gap:10}}>
        <div onClick={full} style={{flex:1,display:"flex",alignItems:"center",justifyContent:"center",gap:6,borderRadius:16,border:`1.5px solid ${T.line}`,padding:"13px 0",fontSize:13,fontWeight:700,color:T.ink,cursor:"pointer"}}>
          <Info size={14}/>See full details
        </div>
        <a href={att.link} target="_blank" rel="noopener noreferrer" style={{flex:1,display:"flex",alignItems:"center",justifyContent:"center",gap:6,borderRadius:16,background:"linear-gradient(135deg,#1D4ED8,#1E40AF)",padding:"13px 0",fontSize:13,fontWeight:700,color:"white",cursor:"pointer",textDecoration:"none",boxShadow:"0 4px 14px rgba(29,78,216,0.25)"}}>
    ...
    {featured&&<div onClick={()=>onPreview(featured)} style={{borderRadius:24,overflow:"hidden",marginBottom:20,cursor:"pointer",position:"relative"}}>
      ...
      <div style={{position:"absolute",bottom:0,left:0,right:0,padding:16}}>
        ...
        <div style={{display:"flex",gap:8,marginTop:12}}>
          ...
          <a href={featured.link} target="_blank" rel="noopener noreferrer" onClick={e=>e.stopPropagation()} style={{padding:"8px 14px",borderRadius:12,background:"white",fontSize:12,fontWeight:700,color:T.dark,textDecoration:"none",display:"flex",alignItems:"center",gap:4}}>Book · €{featured.price}</a>
        </div>
      </div>
    </div>}
    {/* Rest as list */}
...
export default function IstanbulGo(){
  ...
  return(
    <div style={{minHeight:"100vh",background:"radial-gradient(circle at top,#eaf2ff 0%,#f5f7fb 35%)",padding:16,fontFamily:fi}}>
      ...
      <div style={{maxWidth:440,margin:"0 auto",borderRadius:34,border:"1px solid rgba(255,255,255,0.7)",background:"white",boxShadow:T.sh.hero,overflow:"hidden",position:"relative"}}>
        ...
        <div style={{maxHeight:"calc(100vh - 200px)",overflowY:"auto",background:`linear-gradient(180deg,#F8FBFF 0%,${T.bg} 24%)`,padding:"20px 20px 110px"}}>
          ...
          {tab==="home"&&!infoPage&&<>
            ...
            {/* Quick Actions */}
            <div style={{marginBottom:28}}><Lbl>Quick access</Lbl><Hd>Everything you need</Hd><div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:12}}>{[{Icon:Sparkles,l:"Smart Plan",tone:T.primarySoft,ic:T.primary,tap:()=>goTab("plan")},{Icon:Ticket,l:"Tickets",tone:"#FCE7F3",ic:"#BE185D",tap:()=>goTab("book")},{Icon:Train,l:"Transport",tone:T.okSoft,ic:T.ok,tap:()=>setTransOpen(true)},{Icon:Navigation,l:"Explore",tone:T.warnSoft,ic:T.warn,tap:()=>goTab("explore")},{Icon:Smartphone,l:"eSIM",tone:"#EDE9FE",ic:"#6D28D9",tap:()=>setInfoPage("esim")},{Icon:Package,l:"My Trip",tone:T.goldSoft,ic:T.gold,tap:()=>goTab("trip")}].map(q=><div key={q.l} onClick={q.tap} style={{display:"flex",flexDirection:"column",alignItems:"center",gap:8,borderRadius:22,background:"white",padding:"16px 8px",border:`1px solid ${T.line}`,cursor:"pointer"}}><div style={{width:48,height:48,borderRadius:16,background:q.tone,display:"flex",alignItems:"center",justifyContent:"center"}}><q.Icon size={21} color={q.ic} strokeWidth={1.75}/></div><span style={{fontSize:11,fontWeight:600,color:T.inkSoft}}>{q.l}</span></div>)}</div></div>
                ...
                {["hagia","basilica","topkapi","galata","dolma","maiden"].map(id=>ATT.find(a=>a.id===id)).filter(Boolean).map(a=><div key={a.id} style={{minWidth:220,overflow:"hidden",borderRadius:22,border:`1px solid ${T.line}`,background:"white",flexShrink:0}}>
                  ...
                  <div style={{padding:"10px 12px 12px",display:"flex",justifyContent:"space-between",alignItems:"center"}}>
                    ...
                    <div style={{display:"flex",alignItems:"center",gap:6}}>
                      ...
                      <a href={a.link} target="_blank" rel="noopener noreferrer" style={{display:"flex",alignItems:"center",gap:4,height:36,padding:"0 14px",borderRadius:12,background:"linear-gradient(135deg,#1D4ED8,#1E40AF)",color:"white",fontSize:12,fontWeight:700,textDecoration:"none",boxShadow:"0 2px 8px rgba(29,78,216,0.2)"}}>Book<ExternalLink size={10}/></a>
                    </div>
                  </div>
                </div>)}
              </div>
          ...
          {tab==="home"&&(infoPage==="money"||infoPage==="esim")&&<div><div style={{display:"flex",alignItems:"center",gap:12,marginBottom:20}}><Bk onClick={()=>setInfoPage(null)}/><div><Lbl>Guide</Lbl><div style={{fontSize:24,fontWeight:800,fontFamily:fd}}>{infoPage==="money"?"Money & Payments":"eSIM Setup"}</div></div></div>{infoPage==="money"?[{Icon:Wallet,t:"Currency",d:"Turkish Lira (₺). €1 ≈ ₺38-40."},{Icon:CreditCard,t:"Cards vs Cash",d:"Visa/MC tourist areas. Bazaar: cash only."},{Icon:Star,t:"Haggling",d:"Start at 40%. Walk away — they call back."}].map(c=><div key={c.t} style={{borderRadius:20,background:"white",border:`1px solid ${T.line}`,padding:16,marginBottom:12,display:"flex",gap:14}}><div style={{width:44,height:44,borderRadius:14,background:"#F1F5F9",display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0}}><c.Icon size={20} color={T.ink}/></div><div><div style={{fontSize:14,fontWeight:700,marginBottom:4}}>{c.t}</div><div style={{fontSize:13,color:T.inkSoft,lineHeight:1.55}}>{c.d}</div></div></div>):[{t:"Holafly",d:"Unlimited data",p:"€5.90/7d",b:"Popular",tone:T.okSoft,ac:T.ok},{t:"Airalo",d:"Pay per GB",p:"€4.50/1GB",b:"Budget",tone:T.primarySoft,ac:T.primary},{t:"eSIM Turkey",d:"Local support",p:"€4.99/5GB",b:"Local",tone:T.warnSoft,ac:T.warn}].map(e=><div key={e.t} style={{borderRadius:20,background:"white",border:`1px solid ${T.line}`,padding:16,marginBottom:12,display:"flex",alignItems:"center",gap:14}}><div style={{width:48,height:48,borderRadius:16,background:e.tone,display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0}}><Smartphone size={20} color={e.ac}/></div><div style={{flex:1}}><div style={{fontSize:15,fontWeight:700}}>{e.t}</div><div style={{fontSize:12,color:T.inkMute}}>{e.d}</div></div><div style={{fontSize:16,fontWeight:800}}>{e.p}</div></div>)}</div>}
      ...
      {/* MINI PREVIEW */}
      <MiniPreview att={previewAtt} onClose={()=>setPreviewAtt(null)} onFullDetail={(a)=>{setPreviewAtt(null);setTimeout(()=>setDetailAtt(a),250)}} onFav={toggleFav} isFav={previewAtt?favs.has(previewAtt.id):false}/>

      {/* FULL DETAIL */}
      {detailAtt&&<AttractionSheet attraction={detailAtt} allAttractions={ATT} onClose={()=>setDetailAtt(null)} onFav={toggleFav} isFav={favs.has(detailAtt.id)} onOpenOther={a=>setDetailAtt(a)}/>}

      {/* TRANSPORT */}
      {transOpen&&<div style={{position:"fixed",inset:0,zIndex:200}}><div onClick={()=>setTransOpen(false)} style={{position:"absolute",inset:0,background:"rgba(15,23,42,0.45)",backdropFilter:"blur(4px)"}}/><div style={{position:"absolute",bottom:0,left:0,right:0,maxWidth:440,margin:"0 auto",borderRadius:"30px 30px 0 0",background:"white",padding:"12px 20px 32px"}}><div style={{width:48,height:6,borderRadius:3,background:T.line,margin:"0 auto 20px"}}/><div style={{fontSize:24,fontWeight:800,fontFamily:fd,marginBottom:16}}>Transport</div>{TRANS.map(tr=><div key={tr.title} style={{borderRadius:22,border:`1px solid ${T.line}`,background:"#F8FAFC",padding:16,marginBottom:10}}><div style={{display:"flex",alignItems:"center",gap:12}}><div style={{width:48,height:48,borderRadius:16,background:tr.tone,display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0}}><tr.icon size={20} color={tr.ac}/></div><div style={{flex:1}}><div style={{fontSize:14,fontWeight:700}}>{tr.title}</div><div style={{fontSize:12,color:T.inkMute}}>{tr.desc}</div></div><div style={{fontSize:13,fontWeight:700,background:T.dark,color:"white",padding:"10px 16px",borderRadius:16}}>{tr.price}</div></div></div>)}</div></div>}
    </div>
  );
}