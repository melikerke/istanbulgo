      ...
      <div style={{position:"absolute",inset:0,zIndex:400,display:"flex",alignItems:"center",justifyContent:"center",padding:20}}>
        ...
        <div style={{position:"relative",background:"white",borderRadius:24,padding:24,maxWidth:320,width:"100%",boxShadow:"0 20px 60px rgba(0,0,0,0.3)"}}>
          ...
          <div style={{textAlign:"center",marginBottom:20}}>
            ...
            <div style={{fontSize:18,fontWeight:800,fontFamily:fd}}>Install IstanbulGo</div>
            <div style={{fontSize:12,color:C.inkMute,marginTop:4}}>Get faster access from your home screen</div>
          </div>
          ...
          <div style={{background:"#F8FAFC",borderRadius:14,padding:16}}>
            <div style={{display:"flex",alignItems:"flex-start",gap:12,marginBottom:14}}>
              ...
              <div style={{flex:1,fontSize:13,color:C.ink,lineHeight:1.5}}>
                Tap the <Share size={14} style={{display:"inline",verticalAlign:"middle",margin:"0 2px"}}/> Share button at the bottom of Safari
              </div>
            </div>
            <div style={{display:"flex",alignItems:"flex-start",gap:12,marginBottom:14}}>
              ...
              <div style={{flex:1,fontSize:13,color:C.ink,lineHeight:1.5}}>Scroll and tap <strong>"Add to Home Screen"</strong></div>
            </div>
            <div style={{display:"flex",alignItems:"flex-start",gap:12}}>
              ...
              <div style={{flex:1,fontSize:13,color:C.ink,lineHeight:1.5}}>Tap <strong>"Add"</strong> in the top right</div>
            </div>
          </div>
  ...
  return (
    <div style={{position:"absolute",bottom:88,left:16,right:16,zIndex:200,background:"white",border:`1px solid ${C.line}`,borderRadius:18,boxShadow:"0 10px 30px rgba(0,0,0,0.15)",padding:14,display:"flex",alignItems:"center",gap:12}}>
      ...
      <div style={{flex:1,minWidth:0}}>
        <div style={{fontSize:13,fontWeight:800,color:C.ink}}>Install IstanbulGo</div>
        <div style={{fontSize:10,color:C.inkMute,marginTop:1}}>Faster access from your home screen</div>
      </div>
